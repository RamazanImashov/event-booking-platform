...
class EventServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetEventById = channel.unary_unary(
                ...
                request_serializer=event__pb2.EventByIdRequest.SerializeToString,
                response_deserializer=event__pb2.EventByIdResponse.FromString,
...
def add_EventServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetEventById': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=event__pb2.EventByIdRequest.FromString,
                    response_serializer=event__pb2.EventByIdResponse.SerializeToString,
            ),
    }
...
class EventService(object):
    ...
    def GetEventById(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/EventService/GetEventById',
            event__pb2.EventByIdRequest.SerializeToString,
            event__pb2.EventByIdResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
